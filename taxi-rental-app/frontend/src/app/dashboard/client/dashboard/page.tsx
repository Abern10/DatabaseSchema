  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm col-span-full">
        <h2 className="text-xl font-semibold mb-2">Welcome back, {user?.name || 'Client'}</h2>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="text-lg font-semibold">Total Rents</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="text-lg font-semibold">Active Rents</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm col-span-full">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold">Recent Rents</h3>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span 
                      ...
                      ${rent.status === 'Completed' ? 'bg-green-100 text-green-800' : 
                        rent.status === 'Upcoming' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'}`}
                    >
                      {rent.status}
                    </span>
                  </td>
